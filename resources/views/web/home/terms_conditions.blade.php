                ...
                <div class="col-12">
                    <div class="Terms mt-5 mb-5 bg-white border border-1" style="border-radius: 5px;padding: 30px 40px;">
                        <div class="header mb-4">
                            ...
                            <span class=""><b>Last Update: November 2021</b></span>
                        </div>
                        <div class="descriptions">
                            <div class="welcome">
                                <p class="mb-2">
                                    <b>Welcome to FreelancerArabic.com</b>
                                </p>
                            </div>
                            <div class="describe">
                                <div class="describe1 mb-4">
                                    Freelancer Arabic maintains the FreelancerArabic.com Website ("FreelancerArabic"). The following
                                    are the terms of use that govern use of the Site ("<b>Terms of Use</b>"). By using
                                    the Site you expressly agree to be bound by these Terms of Use and the FreelancerArabic.com
                                    privacy policy and to follow these Terms of Use and all applicable laws and regulations
                                    governing use of the Site. Freelancer Arabic reserves the right to change these Terms of Use at any time,
