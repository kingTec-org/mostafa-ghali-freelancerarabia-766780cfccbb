...
@else
    ...
    4
               ...
               <div data-bs-spy="scroll" class="navdownlist container-fluid mt-3 " style="display: none;">
                <ul class="list-unstyled d-flex pt-3">
                    <li class="px-1 ss"><a class=""  href="#">Graphics & Design</a>
                        <ul class="dropdow px-2">
                            <div class="row py-3">
                            <li class="col-6"><a >Graphics& DesignDe</a></li>
                            <li class="col-6"><a >Graphics & Design</a></li>
                            <li class="col-6"><a >Graphics & Design</a></li>
                            <li class="col-6"><a>Graphics</a></li>
                        </div>
                        </ul>
                    </li>
                    <li class="px-1 ss"><a href="#">Digital Marketing </a>
                        <ul class="dropdow px-2">
                            <div class="row py-3">
                                <li class="col-6"><a >Graphics& DesignDe</a></li>
                                <li class="col-6"><a >Graphics & Design</a></li>
                    ...
                    <li class="px-1"><a href="#">Graphics & Design</a></li>
                    <li class="px-1"><a href="#">Digital Marketing </a></li>
                    <li class="px-1"><a href="#">Graphics & Design</a></li>
                    <li class="px-1"><a href="#">Digital Marketing </a></li>
                    <li class="px-1"><a href="#">Graphics & Design</a></li>
                    <li class="px-1"><a href="#">Digital Marketing </a></li>
