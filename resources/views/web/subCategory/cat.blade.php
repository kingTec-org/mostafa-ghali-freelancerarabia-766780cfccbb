...
{{--        <div class="section section-banner">
    ...
    4
        ...
        <div class="container-fluid py-5 mt-5 cate">
            <div class="mx-5">
                <h2 class="text-center">{{getLang() =='ar'?$main_category->name_ar:$main_category->name_en}}</h2>
                <h6 class="text-center">

                </h6>
            </div>
            <div class="row pt-3">
             {{--   <div class="col-md-3 col-sm-12 leftbar">
                    <div>
                        <ul class="">
                            <li class="active_main bold "><a>{{getLang() =='ar'?$main_category->name_ar:$main_category->name_en}}</a></li>
                          @if($subCategory->count() > 0)
                           @foreach($subCategory as $category)
                            <li class="px-1 py-1 listitem"><a href="{{route('store.ServicesBaseSubCategory',$category->id)}}">{{getLang() =='ar'?$category->name_ar:$category->name_en}}</a></li>
                                @endforeach
                            @endif
                        ...
                        <div class="col-md-4 py-2">
                            <a href="{{route('store.ServicesBaseSubCategory',$category->id)}}">
                                <div class="">
                                    ...
                                    <h4 class="px-1 pt-2">{{getLang() =='ar'?$category->name_ar:$category->name_en}}</h4>
