...
{{--                                <a href="{{route('switchLang','ar')}}" class="navi-link">--}}
{{--            <span class="symbol symbol-20 mr-3">--}}
{{--                <img src="{{asset('/template/assets/media/svg/flags/151-united-arab-emirates.svg')}}" alt=""/>--}}
{{--            </span>--}}
...
{{--                            --}}{{----}}{{-- Item --}}
{{--                            <li class="navi-item">--}}
{{--                                <a href="{{route('switchLang','en')}}" class="navi-link">--}}
{{--            <span class="symbol symbol-20 mr-3">--}}
...
{{--                             style="background-image: url({{asset('template/assets/media/misc/bg-1.jpg')}})">--}}
{{--                            <!--begin::Title-->--}}
                    ...
                    <div class="navi navi-spacer-x-0 pt-5">
                        <div class="navi-footer  px-8 py-5">
                            <form action="{{route('admin.logout')}}" method="post">
                                @csrf
                                <button type="submit"  class="btn btn-light-primary font-weight-bold">{{getLang() =='ar'?'تسجيل خروج' :'Logout'}}</button>
                            </form>
                            <a href="{{route('admin.edit.profile')}}" class="btn btn-clean font-weight-bold">Profile</a>
                        </div>
                    </div>
                </div>
            </div>
