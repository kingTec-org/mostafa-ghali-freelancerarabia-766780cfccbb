    ...
    <div class="card card-custom">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                ...
                <h3 class="card-label">Update General Questions</h3>
            </div>
        ...
        <!--begin: Datatable-->
            <form class="form" method="POST" action="{{route('admin.general_questions.update')}}"
                  enctype="multipart/form-data">
                <input type="hidden" value="{{$g_q->id}}" name="id">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <textarea name="question_ar"
                                          ...
                                          rows="4">{{$g_q->question_ar}}</textarea>
                                @error('question_ar')
                            ...
                            <div class="col-lg-6">
                                ...
                                <textarea name="question_en"
                                          ...
                                          rows="4">{{$g_q->question_en}}</textarea>
                                @error('question_en')
                                <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
