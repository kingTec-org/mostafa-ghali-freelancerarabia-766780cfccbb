        ...
        <div class="card-header py-3">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{route('admin.customers.create')}}" class="btn btn-primary font-weight-bolder">
                    <i class="la la-plus"></i>New Customer</a>
                <!--end::Button-->
            </div>
        </div>
        <div class="card-body">
...
@section('script')
    <script>
        var CustomerStatusURL = '{{app_url('admin/customers/changes-status')}}';
    </script>
    <script src="{{ asset('template/js/datatable/customers.js') }}"></script>
    <script>
                ...
                if(result.value){
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            console.log('.customerRow'+ data.customer_id);
                            $('.customerRow'+ customer_id).closest('tr').css('background', '#714f4f').delay(100).hide(100);
