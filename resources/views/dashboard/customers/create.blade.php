...
@section('content')
    ...
    <div class="card card-custom">
        ...
        @include('dashboard.layouts.includes.alerts.errors')
            <!--begin: Datatable-->
            <form class="form" method="POST" action="{{route('admin.customers.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="email" name="email"
                                       class="form-control form-control-solid @error('email') is-invalid  @enderror" value="{{old('email')}}">
                                @error('email')
                                <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
