...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin: Datatable-->
            <form class="form" method="POST" action="{{route('admin.sub_category.update_images')}}"
                        ...
                        @foreach($sub_categories as $sub)
                            <div class="col-md-2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-12">
                                        <label for="">{{$sub["name_".app()->getLocale()]}} image : </label>
                                        <br>
                                        <div class="image-input image-input-outline " id="kt_image_{{$sub->id}}"
                                             style="background-image: url('{{$sub->image}}');background-color: black ">
                                            <div class="image-input-wrapper"
                                                 style="background-image:  url('{{$sub->image}}'); background-color: black"></div>
                                            ...
                                            <label
                                                ...
                                                <input type="file" name="images[{{$sub->id}}]"
...
@section('script')
    <script>
        ...
        new KTImageInput('kt_image_{{$cat->id}}')
        @endforeach
