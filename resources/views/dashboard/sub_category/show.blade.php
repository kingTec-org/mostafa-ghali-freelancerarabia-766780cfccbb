    ...
    <div class="card card-custom">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                ...
                <h3 class="card-label">Show Category</h3>
            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <textarea rows="3" name="name_ar"
                                          class="form-control form-control-solid" disabled>{{$subcategory->name_ar}}</textarea>
                            </div>
                            <div class="col-lg-6">
                                <label for="">Name English : </label>
                                <textarea rows="3" name="name_en"
                                        disabled  class="form-control form-control-solid">{{$subcategory->name_en}}</textarea>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <select disabled type="text" name="category"
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="image-input image-input-outline "
                                ...
                                <div class="image-input-wrapper"
                                     style="width: 250px;height: 250px;background-image:  url('{{$subcategory->image}}'); background-color: black"></div>
