    ...
    <div class="card card-custom">
        ...
        <div class="card-header py-3">
            <div class="card-title">
                ...
                <h3 class="card-label">Update Category ({{$category->name_en}} ) </h3>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <textarea rows="3" name="name_ar"
                                          class="form-control form-control-solid @error('name_ar') is-invalid  @enderror" >{{$category->name_ar}}</textarea>
                                @error('name_ar')
                            ...
                            <div class="col-lg-6">
                                ...
                                <textarea rows="3" name="name_en"
                                          class="form-control form-control-solid @error('name_en') is-invalid  @enderror" >{{$category->name_en}}</textarea>
                                @error('name_en')
                                <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="image-input image-input-outline " id="kt_image_1"
                                    ...
                                    <div class="image-input-wrapper"
                                         style="background-image:  url('{{$category->image}}'); background-color: black"></div>
