...
@endsection
@section('script')
    <script src="{{ asset('template/js/datatable/category.js') }}"></script>
    <script>
                ...
                if(result.value){
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            console.log('.categoryRow'+ data.category_id);
                            $('.categoryRow'+ category_id).closest('tr').css('background', '#714f4f').delay(100).hide(100);
