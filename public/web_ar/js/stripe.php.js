...
(function () {
    ...
    if (this.Stripe.stripejs_ua = "stripe.js/78ef418", !this.Stripe._isChannel && true) try {
        c = [], "function" == typeof window.addEventListener && window.addEventListener("message", function (b) {
            ...
            return q = function (a, b) {
                return s({action: "track", url: window.location.href, source: a, data: b, version: 6})
    ...
    this.Stripe.isDoubleLoaded || (this.Stripe.utils = function () {
        ...
        return c = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, b.trim = function (a) {
            ...
            var a, b, c;
            try {
                return b = this.determineId(this.getCookie("__stripe_mid"), (null != (c = Stripe.__mids) ? c.muid : void 0) || "NA"), this.isServerGeneratedId(b) && this.setCookie("__stripe_mid", b, {domain: "." + document.location.hostname}), b
            } catch (d) {
                return a = d, "NA"
            }
